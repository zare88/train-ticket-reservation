...
* The original package name 'com.samsoltani.ttt.Train Ticket Reservation' is invalid and this project uses 'com.samsoltani.ttt.Train.Ticket.Reservation' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/2.7.0/reference/htmlsingle/#features.sql.jdbc)
